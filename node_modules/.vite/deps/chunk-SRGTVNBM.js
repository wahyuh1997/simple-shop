...
var SiderContext = React35.createContext({});
...
var Sider = React35.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react17.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react17.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react17.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react17.useRef)(null);
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React35.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React35.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React35.createElement(RightOutlined_default, null) : React35.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React35.createElement(LeftOutlined_default, null) : React35.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React35.createElement("div", {
    ...
    return React35.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return wrapCSSVar(React35.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider()));
});
if (true) {
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React36.forwardRef((props, ref) => React36.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React36.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React36.createElement(TagName, Object.assign({
    className: (0, import_classnames3.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId, cssVarCls),
    ref
  }, others)));
});
var BasicLayout = React36.forwardRef((props, ref) => {
  const {
    direction
  } = React36.useContext(ConfigContext);
  const [siders, setSiders] = React36.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapCSSVar(React36.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React36.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-SRGTVNBM.js.map
